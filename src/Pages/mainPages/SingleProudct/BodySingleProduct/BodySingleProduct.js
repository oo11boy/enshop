...
const {singlepro}=props
  const accinfo=useContext(AccountContext)
    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          <Tab label="توضیجات" {...a11yProps(0)} ></Tab>
      ...
      {accinfo.statuslogin ? 
       ...
       <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
         ...
         <Form.Control required type="email" placeholder= '' value={accinfo.emaillogin}/>
       </Form.Group>
     ...
     <Link className=' btn btn-primary' to="../useraccount/login">ورود</Link> </> 
