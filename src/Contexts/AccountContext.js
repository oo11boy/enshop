...
import { UserLogindata } from "../Pages/Database/UserLogindata";
   ...
   function cadrcodeval(event){
    ...
    const navigatepage=useNavigate()
        ...
        function loginsubmit(event) {
            ...
            const statuslogin = UserLogindata.some((item) => item.email === emaillogin && item.password === passlogin)
            ...
            statusloginval && navigatepage('/useraccount/inform');
